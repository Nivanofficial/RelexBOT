...
# PyroClient Setup 
API_ID = int(environ['29034988'])
API_HASH = environ['13cc8c4c122a6702acd51dcf49232978']
BOT_TOKEN = environ['6655878573:AAEzoNZJfdJPP-78KcIEL4u4td_k7B0xD5g']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('625036670', '').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Nivan:Nivan@nivan.ffpccia.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Nivan")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001917121763')
